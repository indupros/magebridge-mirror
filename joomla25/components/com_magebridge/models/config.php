 ...
 */
class MagebridgeModelConfig extends JModel
{
    /**
    ...
    public function __construct()
    {
        $this->_defaults = array(
            ...
            'protocol' => 'http',
            'method' => 'post',
            'encryption' => '1', // @todo: Make this configurable
            'http_auth' => 0,
            'http_user' => '',
            'http_password' => '',
    ...
    public function getData()
    {
        ...
        if (empty($this->_data))
        {
            $query = 'SELECT * FROM #__magebridge_config AS c';
    ...
    public function check($element, $value = null)
    {
        ...
        // Check license
        if ($element == 'license' && empty($value)) {
