...
class Yireo_MageBridge_Block_Settings extends Mage_Core_Block_Template
{
    ...
    {
        return Mage::getModel('adminhtml/url')->getUrl('magebridge/index/resetevents');
    }
    ...
    {
        return Mage::getModel('adminhtml/url')->getUrl('magebridge/index/resetusermap');
    }
    ...
    {
        return Mage::getModel('adminhtml/url')->getUrl('magebridge/index/resetapi');
    }
