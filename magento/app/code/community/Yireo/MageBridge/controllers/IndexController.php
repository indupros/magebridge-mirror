...
class Yireo_MageBridge_IndexController extends Mage_Adminhtml_Controller_Action
{
    ...
    protected function _initAction()
    {
        ...
        if($store->getConfig('web/url/redirect_to_base') == '1') {
            Mage::getModel('adminhtml/session')->addError('The setting "Redirect to Base" is not configured properly [MageBridge Magento Settings Guide]');
        }
    ...
    public function wipelogAction()
    {
        ...
        $url = Mage::getModel('adminhtml/url')->getUrl('magebridge/index/log', array('type' => $type));
