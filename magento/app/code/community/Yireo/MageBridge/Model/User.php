...
class Yireo_MageBridge_Model_User 
{
    ...
    private function doSSOLoginCustomer($username)
    {
        ...
        $token = null; // @todo: token missing ?
        $returnhash = md5($token.$passwordhash);
    ...
    private function loginCustomer($data = array()) 
    {
        ...
        // @todo: Extra check to see if the customer is already logged in
