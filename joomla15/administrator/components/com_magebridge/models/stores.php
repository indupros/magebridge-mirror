 ...
 */
class MagebridgeModelStores extends JModel
{
    /**
     * Data array
     *
    ...
    private function _buildQuery()
    {
        ...
        $query = ' SELECT s.* FROM #__magebridge_stores AS s '
            . $where
            . $orderby
        ;
    ...
    /**
     * Method to get the orderby-segments of the query
     *
     * @package MageBridge
     * @access private
     * @param null
    ...
    /**
     * Method to get the where-segments of the query
     *
     * @package MageBridge
     * @access private
     * @param null
