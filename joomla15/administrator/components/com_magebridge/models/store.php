 ...
 */
class MagebridgeModelStore extends JModel
{
    /**
     * Item id
     *
    ...
    public function delete($cid = array())
    {
        ...
        if (count( $cid )) {
            ...
            $cids = implode( ',', $cid );
            $query = 'DELETE FROM #__magebridge_stores WHERE id IN ( '.$cids.' )';
    ...
    public function publish($cid = array(), $publish = 1)
    {
        ...
        if (count( $cid )) {
            ...
            $query = 'UPDATE #__magebridge_stores'
